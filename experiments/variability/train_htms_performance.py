    ...
    for iter_ in range(iters):
        ...
        if not only_root:
            ...
            for j in num_topics_sub:
                ...
                # Iterate over three random topics from the root model
                for i in random.sample(range(ntopics_root), 3):
                    if version == "htm-ws":
...
def main():
    ...
    parser.add_argument('--version', type=str, default="htm-ds",    
                        help="Version of the HTM to be used: htm-ds|htm-ws")
