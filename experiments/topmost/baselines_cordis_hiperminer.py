...
# Preprocess raw data
#preprocessing = Preprocessing(vocab_size=20373)
...
for iter in range(1, 4): # 5 iterations
    # model = topmost.models.TraCo(dataset.vocab_size, num_topics_list=[10, 50])
